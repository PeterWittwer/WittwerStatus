    ...
    if (profile === null || loading) {
      ...
      if (Object.keys(profile).length > 0) {
        dashboardContent = (
          ...
          <div className="row"> 
              <div id="left_dashboard_columnAA" className="col s12 m2">
                  <div className="card">
          ...
          <div className="card col s12 m5 margin_5">
                <div className="">
                ...
                <div className="card col s12 m3 margin_5">
                    <div className="card col s12 margin_5"> 
                      <BarChart/> 
                    </div>
              ...
              <div id="right_dashboard_columnAA" className="col s12 m4 margin_5">
                <ProfileActions />
              </div>
